...
const Stocke = () => {
  ...
  return (
    <View style={{padding:'1%',bottom: '1%'}} >
      <Text style={{color: 'gold', textAlign: 'center', fontSize: 30, bottom: 15}} >Наши акции и новинки!</Text>
        <View style={{flex: 1 , flexWrap: 'nowrap',flexDirection: 'row', marginBottom: '2%', borderBottomColor: 'red', borderBottomWidth: 1, borderRadius: 10}}  >
